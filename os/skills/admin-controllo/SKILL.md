...
L'azienda è una società italiana (es. SRL innovativa).
...
**Processo**:
1. Leggi `vault/finance/scadenzario.md`
...
**Processo**:
1. Carica `vault/finance/cashflow.md`
...
**Processo**:
1. Leggi `vault/finance/fatturazione.md`
2. Mostra:
...
**Processo**:
1. Leggi `vault/finance/costi-ricorrenti.md`
...
1. Verifica requisiti per:
   ...
   - **Bandi regionali** (es. bandi della propria regione)
...
- "La fattura al cliente di febbraio non è ancora stata emessa — la emettiamo?"
