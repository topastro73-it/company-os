...
Sincronizza le fatture emesse da Fatture in Cloud e aggiorna `vault/finance/fatturazione.md`.
...
/finance fatture-in-cloud sync-invoices 2026      # anno specifico
/finance fatture-in-cloud sync-invoices 2026-01   # mese specifico
```
...
Riscrivi la tabella `## Fatture emesse {anno}` in `vault/finance/fatturazione.md`:

```markdown
| N. | Data emissione | Cliente | Descrizione | Imponibile | IVA | Totale | Scadenza | Stato | Incassata il |
|----|----------------|---------|-------------|-----------|-----|--------|----------|-------|-------------|
| 1/2026 | 2026-01-15 | Acme | Canone Jan | €8.197 | €1.803 | €10.000 | 2026-02-14 | ✅ Incassata | 2026-02-10 |
| 2/2026 | 2026-01-31 | Beta | Canone Jan | €3.415 | €751 | €4.167 | 2026-03-01 | ⚠️ Scaduta | — |
```
