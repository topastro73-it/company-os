...
Legge la prima nota da Fatture in Cloud e aggiorna `vault/finance/cashflow.md`.
...
/finance fatture-in-cloud sync-cashflow 2026-03   # mese specifico
```
...
Aggiorna `## Saldo corrente` in `vault/finance/cashflow.md`:
...
| 5/2026 | Acme | €4.167 | 2026-02-01 | Alta (51gg, cliente attivo) |
```
