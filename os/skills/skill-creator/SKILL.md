...
- `os/skills/SKILLS.md` — per capire le skill esistenti ed evitare duplicati
- `os/agents/AGENTS.md` — per conoscere gli agenti disponibili come owner
...
→ Claude mappa su agenti esistenti in `os/agents/`. Se l'utente nomina un ruolo non mappato, Claude chiede di confermare l'agente più vicino.
...
1. **`os/skills/{slug}/SKILL.md`** — usando il template sotto
2. **Aggiorna `os/skills/SKILLS.md`** — aggiunge la riga nella tabella corretta (operativa o contesto)
