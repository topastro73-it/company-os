...
/finance qonto reconcile 2026-03   # mese specifico
```

## Prerequisiti

Eseguire prima:
- `/finance fatture-in-cloud sync-invoices` (per avere fatture aggiornate)
- `/finance qonto sync-transactions` (per avere movimenti aggiornati)
...
|---------|---------|---------|-------------------|------------|
| 8/2026 | Acme | €12.000 | 2026-03-01 | Importo esatto |
