...
Legge i saldi correnti dei conti Qonto e aggiorna `vault/finance/cashflow.md`.
...
Se il saldo totale differisce significativamente dalla "Cassa stimata" in `company/direzione/metrics/kpis.md`, aggiorna il valore.
