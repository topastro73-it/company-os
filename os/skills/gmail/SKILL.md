...
3. **Mai dati sensibili in file pubblici** — Importi, dati personali, contenuti di NDA/contratti non vanno nelle zone leggibili da tutti (`company/prodotto/`, `company/marketing/`, zone condivise); i dati 🔴 restano in `vault/` / `company/finance/`.
