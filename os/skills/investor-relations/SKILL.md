...
| `pitch-prep` | Preparazione call con investitore specifico | Brief in `company/direzione/investor-updates/` |
| `term-sheet-review` | Analisi clausole term sheet con benchmark | Analisi in `company/direzione/investor-updates/` |
| `board-prep` | Preparazione board meeting | Deck outline in `company/direzione/investor-updates/` |
| `cap-table` | Genera/aggiorna cap table | `vault/finance/cap-table.md` |
| `investor-crm` | Traccia relazioni e pipeline investitori | `vault/finance/investor-pipeline.md` |
...
|-----------|------------|---------|
| Pitch deck aggiornato | `company/direzione/investor-updates/pitch-deck-*.md` | Scansiona |
| One-pager / Executive summary | `company/direzione/investor-updates/exec-summary.md` | Scansiona |
| Company profile | `zones/_root/context/COMPANY.md` | Sempre presente |
| Vision e strategia | `company/direzione/strategy/vision.md` | Scansiona |
| OKR correnti | `company/direzione/strategy/okr-*.md` | Scansiona |

#### 2. Financials
| Documento | Path atteso | Verifica |
|-----------|------------|---------|
| Financial model / proiezioni | `vault/finance/financial-model.md` | Scansiona |
| Pricing attuale | `vault/finance/pricing.md` | Scansiona |
| KPI dashboard | `company/direzione/metrics/kpis.md` | Scansiona |
| Cap table | `vault/finance/cap-table.md` | Scansiona |
| Burn rate e runway | In `company/direzione/metrics/kpis.md` | Verifica dati compilati |
| MRR / ARR storico | In `company/direzione/metrics/kpis.md` | Verifica dati compilati |

#### 3. Product
| Documento | Path atteso | Verifica |
|-----------|------------|---------|
| Roadmap | `company/prodotto/roadmap.md` | Scansiona |
| Specs / PRD principali | `company/prodotto/specs/*.md` | Conta e verifica status |
| Backlog | `company/prodotto/backlog.md` | Scansiona |
| Architecture overview | `company/direzione/reports/architecture-*.md` | Scansiona |
| Demo / screenshot | `company/marketing/demo-*` | Scansiona |

#### 4. Market
| Documento | Path atteso | Verifica |
|-----------|------------|---------|
| Segmenti clienti | `company/commerciale/segments.md` | Scansiona |
| Competitor analysis / battlecards | `company/commerciale/competitors/battlecards/*.md` | Conta |
| TAM/SAM/SOM | `company/direzione/strategy/market-sizing.md` | Scansiona |
| Case study / testimonial | `company/marketing/case-study-*.md` | Scansiona |

#### 5. Team
| Documento | Path atteso | Verifica |
|-----------|------------|---------|
| Team overview | `config/people.yaml` | Sempre presente |
| Organigramma | `company/direzione/operations/operating-model.md` | Scansiona |
| Hiring plan | `company/direzione/team/hiring-plan.md` | Scansiona |

#### 6. Legal
| Documento | Path atteso | Verifica |
|-----------|------------|---------|
| Statuto / atto costitutivo | `vault/legal/statuto.md` o `.pdf` | Scansiona |
| Certificazioni (es. ISO 27001 — se applicabili) | In `zones/_root/context/COMPANY.md` | Verifica sezione |
| Privacy policy / GDPR | `vault/legal/privacy-*.md` | Scansiona |
| Contratti tipo partner | `vault/legal/contract-template-*.md` | Scansiona |
| IP ownership / brevetti | `vault/legal/ip-*.md` | Scansiona |
...
Salva in: `company/direzione/investor-updates/data-room-audit-{YYYY-MM-DD}.md`
...
2. Analizza fit con l'azienda:
   - Allineamento thesis-prodotto
   - Portfolio conflict (hanno gia investito in cybersecurity B2B?)
...
Salva in: `company/direzione/investor-updates/pitch-prep-{slug-investitore}-{YYYY-MM-DD}.md`
...
Salva in: `company/direzione/investor-updates/term-sheet-review-{slug}-{YYYY-MM-DD}.md`
...
1. Raccogli dati aggiornati da:
   - `company/direzione/metrics/kpis.md` — KPI attuali
   - `company/prodotto/roadmap.md` — stato roadmap
   - `vault/finance/pricing.md` — pricing e revenue
   - `20-Clienti/*/overview.md` — stato partner
   - `decisions/` — decisioni recenti
   - `company/direzione/strategy/` — OKR e strategia
...
Salva in: `company/direzione/investor-updates/board-prep-{YYYY-MM-DD}.md`
...
### Processo
1. Leggi `vault/finance/cap-table.md`
...
### Output
Aggiorna `vault/finance/cap-table.md`
...
### Processo
1. Leggi `vault/finance/investor-pipeline.md`
...
### Output
Aggiorna `vault/finance/investor-pipeline.md`
...
### Mensile
- **Runway alert**: se runway < 9 mesi (calcolato da burn rate e cash in `company/direzione/metrics/kpis.md`), genera alert automatico:
  ```
...
| KPI (per runway calc) | `company/direzione/metrics/kpis.md` |
