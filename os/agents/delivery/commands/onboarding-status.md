...
4. **Milestone critiche**: primo uso reale del prodotto (g.14), team formato (sett.4), primo deal (sett.8),
...
| {nome} | SETUP | 2/12 | 40% | Primo uso reale (g.7) | task 1.4 in ritardo |
